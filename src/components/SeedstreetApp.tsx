...
const BottomNav = ({ activeTab, setActiveTab, userRole }) => {
  const navItems = [
...
const MenuItem = ({ icon, label, count }) => (
  <button className="w-full flex items-center justify-between p-4 hover:bg-gray-50 active:bg-gray-100 transition-colors border-b border-gray-100 last:border-b-0">
    <div className="flex items-center gap-3">
